...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">ادارة الطلاب
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="student.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">اعادة الى الخلف </a>':'<a href="student.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> اضف طالب جديد</a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-success">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "اضافة معلومات طالب جديد": "تعديل بيانات الطالب"; ?>
                        </div>
						<form action="student.php" method="post" id="signupForm1" class="form-horizontal">
                        <div class="panel-body">
						<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">معلومات شخصية:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">الاسم الكامل* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="sname" name="sname" value="<?php echo $sname;?>"  />
								</div>
							</div>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">رقم الهاتف* </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">المرحلة الدراسية* </label>
								<div class="col-sm-10">
									<select  class="form-control" id="grade" name="grade" >
									<option value="" >اختار مرحلة دراسية</option>
                                    <?php
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">تاريخ الانضمام* </label>
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="تاريخ الالتحاق بلمدرسة" id="joindate" name="joindate" value="<?php echo  ($joindate!='')?date("Y-m-d", strtotime($joindate)):'';?>" style="background-color: #fff;" readonly />
								</div>
							</div>
						 </fieldset>
							...
							<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">بيانات الرسوم:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">الرسوم الكلية* </label>
								<div class="col-sm-10">
						...
						?>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">الرسوم السابقة* </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">الجميع </label>
								<div class="col-sm-10">
						...
						?>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">ملاحظة حول الرسوم </label>
								<div class="col-sm-10">
						...
						?>
							 ...
							 <fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">معلومات اختيارية  :</legend>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">حول الطالب </label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">البريد الالكتروني </label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								...
								<input type="hidden" name="action" value="<?php echo $action;?>">
									...
									<button type="submit" name="save" class="btn btn-success" style="border-radius:0%">حفظ </button>
